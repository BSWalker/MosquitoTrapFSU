...
# this script contains classes and functions that were taken from the examples provided by
# the blueZ project. The gatt-server and advertisement functions were grouped together into
# a single script to simplify usage of the D-bus API. This allows one script to register GATT
# services and advertise them.

# note that this file contains no main loop - it is meant to be imported into another script
# that actually initiates the advertisement and registers the services
